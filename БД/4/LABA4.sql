...
------Создание и заполнение таблицы TEACHER
 ...
 (   TEACHER    char(10),
     TEACHER_NAME  varchar(100)constraint TEACHER_NAME_PK  primary key, 
...
insert into STUDENT (IDGROUP,NAME, BDAY)
    values (3, 'Яцкевич Галина Иосифовна',       '02.08.1993'),
...
insert into PROGRESS (SUBJECT, IDSTUDENT, PDATE, NOTE)
    values  ('ОАиП', 1,  '01.10.2013',8),
           ('ОАиП', 2,  '01.10.2013',7),
           ('ОАиП', 3,  '01.10.2013',5),
           ('ОАиП', 5,  '01.10.2013',4)
insert into PROGRESS (SUBJECT, IDSTUDENT, PDATE, NOTE)
    values   ('СУБД', 14,  '01.12.2013',5),
           ('СУБД', 15,  '01.12.2013',9),
           ('СУБД', 16,  '01.12.2013',5),
           ('СУБД', 17,  '01.12.2013',4)
insert into PROGRESS (SUBJECT, IDSTUDENT, PDATE, NOTE)
    values ('КГ',   18,  '06.5.2013',4),
           ('КГ',   19,  '06.05.2013',7),		
           ('КГ',   20,  '06.05.2013',7),
           ('КГ',   21,  '06.05.2013',9),
           ('КГ',   22,  '06.05.2013',5),
